...
public abstract class Servicio implements ITipoServicio, Serializable {
    ...
    public static class ServicioBuilder
    {
        ...
        // required parameters
        private Vehiculo builderVehiculo;
        private Calendar tInicial;
        private Calendar tFinal;


        public ServicioBuilder(Vehiculo pVehiculo, Calendar pInicial, Calendar pFinal)
        {
                this.builderVehiculo=pVehiculo;
                this.tInicial=pInicial;
                this.tFinal=pFinal;
        }

        public Servicio build()
        {
                return new ServicioActivo(this);
        }
    }
    @Override
